  ...
  return (
    <>
      <div css={mobileWrapper}>
        <Header />
        <br />
        <div className="ifGroupNull" css={ifGroupNull}>
          <h1 css={h1}>오늘은 어떤 그룹을 관리할까요?</h1>
          <svg
          ...
          <p css={p}>아직 만든 그룹이 없어요!</p>
        </div>
        <div className="ifGroupNotNull">
          <h1 css={h1}>오늘은 어떤 그룹을 관리할까요?</h1>
        </div>
      </div>
    </>
